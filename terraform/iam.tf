resource "aws_iam_role" "aws_iam_role_master" {
...
resource "aws_iam_role_policy" "aws_iam_policy_master" {
  name       = "${var.prefix}-iam-policy-master"
  role       = aws_iam_role.aws_iam_role_master.id
  depends_on = [aws_iam_role.aws_iam_role_master]
...
resource "aws_iam_instance_profile" "aws_iam_profile_master" {
  name       = "${var.prefix}-iam-profile-master"
  role       = aws_iam_role.aws_iam_role_master.name
  depends_on = [aws_iam_role_policy.aws_iam_policy_master]
}
